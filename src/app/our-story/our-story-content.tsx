  ...
  return (
    <main className="min-h-screen bg-white">
      ...
      <section className="py-20 bg-gradient-to-r from-blue-900 via-purple-900 to-blue-800 relative overflow-hidden">
        {/* Simplified decorative elements - removed blur-3xl for mobile GPU performance */}
        <div className="absolute inset-0 opacity-10">
          <div className="absolute top-20 left-20 w-64 h-64 bg-amber-500 rounded-full opacity-30" />
          <div className="absolute bottom-20 right-20 w-96 h-96 bg-pink-500 rounded-full opacity-20" />
        </div>
            ...
            <div className="space-y-12 md:space-y-16">
              {[
                ...
                },
                {
                  ...
                  description: 'After 20 years in the industry, Doug launched Down Right Plumbing in Rockwall, TX. New company, veteran experience, and a mission rooted in family.',
                },
              ].map((milestone, index) => (
                <motion.div
                  key={index}
                ...
                >
                  <div className={`md:w-1/2 ${index % 2 === 0 ? 'md:text-right' : 'md:text-left'}`}>
                    <div className="bg-gradient-to-br from-amber-100 to-orange-100 rounded-2xl shadow-lg p-8 hover:shadow-xl transition-shadow">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {[
              ...
              },
              {
                ...
                description: 'When we say we\'ll be there at 2 PM, we\'re there at 2 PM. When we quote a price, that\'s the price. We do what we say and stand behind every job.',
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <div className="flex flex-wrap justify-center gap-4 text-sm md:text-base">
              <span className="bg-white/20 px-6 py-3 rounded-full border border-white/30">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
              <Link
                href="/contact"
                className="bg-amber-500 hover:bg-amber-600 text-white font-bold py-4 px-8 rounded-full text-lg transition-colors shadow-xl inline-flex items-center gap-2"
              >
              ...
              <a
                href="tel:2148023042"
                className="bg-blue-900 hover:bg-blue-800 text-white font-bold py-4 px-8 rounded-full text-lg transition-colors shadow-xl inline-flex items-center gap-2"
              >
            ...
            <div className="inline-flex flex-col md:flex-row gap-6 items-center justify-center bg-gradient-to-br from-amber-50 to-orange-50 px-8 py-6 rounded-2xl">
              ...
              <div className="text-left">
                ...
                <div className="text-gray-600">20+ Years of Plumbing Experience &bull; New Company, Veteran Plumber</div>
              </div>
            </div>
          </motion.div>
        </div>
